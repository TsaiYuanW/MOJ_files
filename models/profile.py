...
class Profile(models.Model):
    ...
    current_assignment = models.OneToOneField('AssignmentParticipation', verbose_name=_('current assignment'),
    ...
    remove_assignment.alters_data = True

    def update_assignment(self):
        assignment = self.current_assignment
        if assignment is not None and (assignment.ended or not assignment.assignment.is_accessible_by(self.user)):
